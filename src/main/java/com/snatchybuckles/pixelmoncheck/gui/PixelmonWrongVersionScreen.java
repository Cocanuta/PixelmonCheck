...
public class PixelmonWrongVersionScreen extends CustomModLoadingErrorDisplayException
{
	...
	public void drawScreen(GuiErrorScreen errorScreen, FontRenderer fontRenderer, int mouseRelX, int mouseRelY, float tickTime)
	{
		...
		int offset = 50;
		errorScreen.drawCenteredString(fontRenderer, "Wrong version of Pixelmon found!", errorScreen.width/2, (errorScreen.height/2) - offset, 0xFFFFFF);
		offset -= 15;
		...
		offset -= 15;
		errorScreen.drawCenteredString(fontRenderer, "Please update Pixelmon to continue.", errorScreen.width/2, (errorScreen.height/2) + offset, 0xFFFFFF);
	}
